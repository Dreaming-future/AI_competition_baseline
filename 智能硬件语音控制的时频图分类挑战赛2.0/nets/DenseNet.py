...
def DenseNet169(num_classes):
    ...
    inchannel = densenet169.classifier.in_features
    densenet169.classifier = nn.Linear(inchannel, num_classes)
...
def DenseNet201(num_classes=1000):
    ...
    # print(densenet201)
    inchannel = densenet201.classifier.in_features
    densenet201.classifier = nn.Linear(inchannel, num_classes)
    return densenet201
...
def DenseNet161(num_classes = 1000):
    ...
    inchannel = densenet161.classifier.in_features
    densenet161.classifier = nn.Linear(inchannel, num_classes)
